...
const Rows = (() => {
  ...
  const makeRow = (data) => {
    ...
    tr.innerHTML = `
      ...
      <td class="col-durasi dur"><b class="dur-v" style="display:none"> </b><input data-f="durasi" data-nav class="in mono ctr durasi-input" type="text" inputmode="decimal" maxlength="4" placeholder="0" aria-label="Durasi (menit)"></td>
